...
TOKEN = '5063871953:AAF1dRZkltVS3y9dVKIfyDyMx4hCjGy8WZw'

# TelegramBot
API_KEY = '5063871953:AAF1dRZkltVS3y9dVKIfyDyMx4hCjGy8WZw'
...
def main():
    ...
    updater.start_webhook(listen="0.0.0.0",
                          port=int(PORT),
                          url_path=TOKEN)
    updater.bot.setWebhook('https://easyfaces.herokuapp.com/' + TOKEN)
